...
function (h, e) {
    ...
    i.Defaults = {
        ...
        "youtube" === t.type ? (o = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg", i(o)) : "vimeo" === t.type ? h.ajax({
            type: "GET",
        ...
        this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), e = this._core.items(this._core.relative(e.index())), this._core.reset(e.index()), (t = h('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", o), t.attr("width", s), "youtube" === i.type ? t.attr("src", "//www.youtube.com/embed/" + i.id + "?autoplay=1&rel=0&v=" + i.id) : "vimeo" === i.type ? t.attr("src", "//player.vimeo.com/video/" + i.id + "?autoplay=1") : "vzaar" === i.type && t.attr("src", "//view.vzaar.com/" + i.id + "/player?autoplay=true"), h(t).wrap('<div class="owl-video-frame" />').insertAfter(e.find(".owl-video")), this._playing = e.addClass("owl-video-playing"))
...
function (s) {
    ...
    var e = function (t) {
        this.owl = t, this._thumbcontent = [], this._identifier = 0, this.owl_currentitem = this.owl.options.startPosition, this.$element = this.owl.$element, this._handlers = {
            "prepared.owl.carousel": s.proxy(function (t) {
                var e;
                !t.namespace || !this.owl.options.thumbs || this.owl.options.thumbImage || this.owl.options.thumbsPrerendered || this.owl.options.thumbImage ? t.namespace && this.owl.options.thumbs && this.owl.options.thumbImage && (e = s(t.content).find("img"), this._thumbcontent.push(e)) : void 0 !== s(t.content).find("[data-thumb]").attr("data-thumb") && this._thumbcontent.push(s(t.content).find("[data-thumb]").attr("data-thumb"))
            }, this),
            "initialized.owl.carousel": s.proxy(function (t) {
    ...
    e.Defaults = {
        ...
        i.thumbsPrerendered && (this._thumbcontent._thumbcontainer = s("." + i.thumbContainerClass)), s(this._thumbcontent._thumbcontainer).on("click", this._thumbcontent._thumbcontainer.children(), s.proxy(function (t) {
            ...
            var e = (s(t.target).parent().is(this._thumbcontent._thumbcontainer) ? s(t.target) : s(t.target).closest("." + i.thumbItemClass)).index();
        ...
        if (e.thumbsPrerendered ? (this._thumbcontent._thumbcontainer = s("." + e.thumbContainerClass), e.moveThumbsInside && this._thumbcontent._thumbcontainer.appendTo(this.$element)) : this._thumbcontent._thumbcontainer = s("<div>").addClass(e.thumbContainerClass).appendTo(this.$element), e.thumbImage)
        ...
        var t = this.owl.options,
            t = t.thumbsPrerendered ? s("." + t.thumbContainerClass + '[data-slider-id="' + this._identifier + '"]') : this._thumbcontent._thumbcontainer;
        t.children().filter(".active").removeClass("active"), t.children().eq(this.owl_currentitem).addClass("active")
    }, e.prototype.destroy = function () {
        var t, e;
        ...
        easyResponsiveTabs: function (l) {
            ...
            f(this).on("bind", "tabactivate", function (t, e) {
                ...
                s.find("ul.resp-tabs-list." + l.tabidentify + " li").addClass("resp-tab-item").addClass(l.tabidentify), s.css({
                    display: "block",
                    width: u
                }), "vertical" == l.type && s.find(".resp-tabs-container." + l.tabidentify).css("border-color", l.active_content_border_color), s.find(".resp-tabs-container." + l.tabidentify + " > div").addClass("resp-tab-content").addClass(l.tabidentify), "vertical" == c && s.addClass("resp-vtabs").addClass(l.tabidentify), 1 == h && s.css({
                    width: "100%",
                    margin: "0px"
                ...
                var r, a = 0;
                "" == d || null !== (r = d.match(new RegExp(o + "([0-9]+)"))) && 2 === r.length && (a = parseInt(r[1], 10) - 1, e < a && (a = 0)), f(s.find(".resp-tab-item." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                    "background-color": l.activetab_bg,
                    "border-color": l.active_border_color
                }), !0 === l.closed || "accordion" === l.closed && !t.is(":visible") || "tabs" === l.closed && t.is(":visible") || (f(s.find(".resp-accordion." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                    "background-color": l.activetab_bg + " !important",
                    "border-color": l.active_border_color,
                    background: "none"
                }), f(s.find(".resp-tab-content." + l.tabidentify)[a]).addClass("resp-tab-content-active").addClass(l.tabidentify).attr("style", "display:block")), s.find("[role=tab]").each(function () {
...
function (f, o, t, m) {
    ...
    function c(t, e) {
        this.element = t, this.options = f.extend({}, i, e), this._defaults = i, this._name = s, this.init()
    }
    c.prototype = {
        init: function () {
        ...
        _defineElements: function () {
            this.element === t.body && (this.element = o), this.$scrollElement = f(this.element), this.$element = this.element === o ? f("body") : this.$scrollElement, this.$viewportElement = this.options.viewportElement !== m ? f(this.options.viewportElement) : this.$scrollElement[0] === o || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
        },
        ...
        _defineSetters: function () {
            ...
            this._setScrollLeft = "function" == typeof e ? function (t) {
                ...
                i(n.$scrollElement, t)
            } : f.noop, this._setPosition = r.setPosition || function (t, e, i, s, o) {
        ...
        refresh: function (t) {
            var i = this,
                e = i._getScrollLeft(),
                s = i._getScrollTop();
            t && t.firstLoad || this._reset(), this._setScrollLeft(0), this._setScrollTop(0), this._setOffsets(), this._findParticles(), this._findBackgrounds(), t && t.firstLoad && /WebKit/.test(navigator.userAgent) && f(o).on("load", function () {
        ...
        _findParticles: function () {
            ...
            if (this.particles !== m)
                for (var t = this.particles.length - 1; 0 <= t; t--) this.particles[t].$element.data("stellar-elementIsActive", m);
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function (t) {
                var e, i, s, o, n, r, a, l = f(this),
                    c = 0,
                    h = 0,
                    u = 0,
                    d = 0;
                ...
                p.options.showElement(l), l.data("stellar-startingLeft") ? (l.css("left", l.data("stellar-startingLeft")), l.css("top", l.data("stellar-startingTop"))) : (l.data("stellar-startingLeft", l.css("left")), l.data("stellar-startingTop", l.css("top"))), e = l.position().left, i = l.position().top, s = "auto" === l.css("margin-left") ? 0 : parseInt(l.css("margin-left"), 10), o = "auto" === l.css("margin-top") ? 0 : parseInt(l.css("margin-top"), 10), r = l.offset().left - s, a = l.offset().top - o, l.parents().each(function () {
                    var t = f(this);
                    if (!0 === t.data("stellar-offset-parent")) return c = u, h = d, n = t, !1;
                    u += t.position().left, d += t.position().top
                }), s = l.data("stellar-horizontal-offset") !== m ? l.data("stellar-horizontal-offset") : n !== m && n.data("stellar-horizontal-offset") !== m ? n.data("stellar-horizontal-offset") : p.horizontalOffset, o = l.data("stellar-vertical-offset") !== m ? l.data("stellar-vertical-offset") : n !== m && n.data("stellar-vertical-offset") !== m ? n.data("stellar-vertical-offset") : p.verticalOffset, p.particles.push({
                    $element: l,
                    $offsetParent: n,
        ...
        _findBackgrounds: function () {
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (t = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (t = t.add(this.$element)), t.each(function () {
                ...
                n.data("stellar-backgroundStartingLeft") ? g(n, n.data("stellar-backgroundStartingLeft"), n.data("stellar-backgroundStartingTop")) : (n.data("stellar-backgroundStartingLeft", r[0]), n.data("stellar-backgroundStartingTop", r[1])), t = "auto" === n.css("margin-left") ? 0 : parseInt(n.css("margin-left"), 10), e = "auto" === n.css("margin-top") ? 0 : parseInt(n.css("margin-top"), 10), i = n.offset().left - t - d, s = n.offset().top - e - p, n.parents().each(function () {
                    var t = f(this);
                    if (!0 === t.data("stellar-offset-parent")) return a = c, l = h, o = t, !1;
                    c += t.position().left, h += t.position().top
                }), t = n.data("stellar-horizontal-offset") !== m ? n.data("stellar-horizontal-offset") : o !== m && o.data("stellar-horizontal-offset") !== m ? o.data("stellar-horizontal-offset") : u.horizontalOffset, e = n.data("stellar-vertical-offset") !== m ? n.data("stellar-vertical-offset") : o !== m && o.data("stellar-vertical-offset") !== m ? o.data("stellar-vertical-offset") : u.verticalOffset, u.backgrounds.push({
                    $element: n,
                    $offsetParent: o,
                    ...
                    parentOffsetLeft: a,
                    parentOffsetTop: l,
                    stellarRatio: n.data("stellar-background-ratio") === m ? 1 : n.data("stellar-background-ratio")
                })
            }))
        },
        _reset: function () {
            ...
            for (o = this.backgrounds.length - 1; 0 <= o; o--)(s = this.backgrounds[o]).$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null), g(s.$element, s.startingValueLeft, s.startingValueTop)
        },
        destroy: function () {
            this._reset(), this.$scrollElement.unbind("resize." + this.name).unbind("scroll." + this.name), this._animationLoop = f.noop, f(o).unbind("load." + this.name).unbind("resize." + this.name)
        },
        ...
        _repositionElements: function () {
            var t, e, i, s, o, n, r, a, l, c, h = this._getScrollLeft(),
        ...
        return e === m || "object" == typeof e ? this.each(function () {
            f.data(this, "plugin_" + s) || f.data(this, "plugin_" + s, new c(this, e))
        }) : "string" == typeof e && "_" !== e[0] && "init" !== e ? this.each(function () {
            var t = f.data(this, "plugin_" + s);
            t instanceof c && "function" == typeof t[e] && t[e].apply(t, Array.prototype.slice.call(i, 1)), "destroy" === e && f.data(this, "plugin_" + s, null)
        }) : void 0
    }, f[s] = function (t) {
        var e = f(o);
        return e.stellar.apply(e, Array.prototype.slice.call(arguments, 0))
    }, f[s].scrollProperty = a, f[s].positionProperty = l, o.Stellar = c
...
function (t) {
    ...
    t.prototype = {
        ...
        open: function (t) {
            ...
            if (!f.isOpen) {
                ...
                d("BeforeOpen"), f.st.showCloseBtn && (f.st.closeBtnInside ? (h(v, function (t, e, i, s) {
                ...
                return f.isIE7 && (l += " mfp-ie7"), l && f._addClassToMFP(l), f.updateItemHTML(), d("BuildControls"), c("html").css(a), f.bgOverlay.add(f.wrap).prependTo(f.st.prependTo || c(document.body)), f._lastFocusedEl = document.activeElement, setTimeout(function () {
                    f.content ? (f._addClassToMFP(_), f._setFocus()) : f.bgOverlay.addClass(_), m.on("focusin" + w, f._onFocusIn)
        ...
        _close: function () {
            ...
            f.bgOverlay.detach(), f.wrap.detach(), f.container.empty(), f.st.mainClass && (t += f.st.mainClass + " "), f._removeClassFromMFP(t), f.fixedContentPos && (t = {
                marginRight: ""
            }, f.isIE7 ? c("body, html").css("overflow", "") : t.overflow = "", c("html").css(t)), m.off("keyup.mfp focusin" + w), f.ev.off(w), f.wrap.attr("class", "mfp-wrap").removeAttr("style"), f.bgOverlay.attr("class", "mfp-bg"), f.container.attr("class", "mfp-container"), !f.st.showCloseBtn || f.st.closeBtnInside && !0 !== f.currTemplate[f.currItem.type] || f.currTemplate.closeBtn && f.currTemplate.closeBtn.detach(), f.st.autoFocusLast && f._lastFocusedEl && c(f._lastFocusedEl).focus(), f.currItem = null, f.content = null, f.currTemplate = null, f.prevHeight = 0, d("AfterClose")
        },
        ...
        updateItemHTML: function () {
            ...
            var e = t.type;
            d("BeforeChange", [f.currItem ? f.currItem.type : "", e]), f.currItem = t, f.currTemplate[e] || (i = !!f.st[e] && f.st[e].markup, d("FirstMarkupParse", i), f.currTemplate[e] = !i || c(i)), o && o !== t.type && f.container.removeClass("mfp-" + o + "-holder");
        ...
        updateStatus: function (t, e) {
            var i;
            f.preloader && (s !== t && f.container.removeClass("mfp-s-" + s), e || "loading" !== t || (e = f.st.tLoading), d("UpdateStatus", i = {
                status: t,
                text: e
        ...
        n();
        var e, i, s, o = c(this);
        return "string" == typeof t ? "open" === t ? (e = a ? o.data("magnificPopup") : o[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, s = e.items ? e.items[i] : (s = o, e.delegate && (s = s.find(e.delegate)), s.eq(i)), f._openClick({
            mfpEl: s
        }, o, e)) : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1)) : (t = c.extend(!0, {}, t), a ? o.data("magnificPopup", t) : o[0].magnificPopup = t, f.addGroup(o, t)), o
    };
        ...
        proto: {
            ...
            getInline: function (t, e) {
                if (C(), t.src) {
                    var i, s = f.st.inline,
                        o = c(t.src);
                    return o.length ? ((i = o[0].parentNode) && i.tagName && (T || ($ = s.hiddenClass, T = u($), $ = "mfp-" + $), S = o.after(T).detach().removeClass($)), f.updateStatus("ready")) : (f.updateStatus("error", s.tNotFound), o = c("<div>")), t.inlineElement = o
                }
    ...
    c.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function () {
                f.types.push(A), I = f.st.ajax.cursor, h(l + "." + A, E), h("BeforeChange." + A, E)
            },
            getAjax: function (s) {
                ...
                var t = c.extend({
                    ...
                    success: function (t, e, i) {
                        ...
                        d("ParseAjax", i), f.appendContent(c(i.data), A), s.finished = !0, z(), f._setFocus(), setTimeout(function () {
                            f.wrap.addClass(_)
    ...
    c.magnificPopup.registerModule("image", {
        ...
        proto: {
                ...
                var i = 0,
                    ...
                    o = function (t) {
                        P && clearInterval(P), P = setInterval(function () {
                            return 0 < s.naturalWidth ? void f._onImageHasSize(e) : (200 < i && clearInterval(P), void(3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500)))
                        }, t)
                    };
                o(1)
            },
            getImage: function (t, e) {
                var i, s = 0,
                    o = function () {
                        t && (t.img[0].complete ? (t.img.off(".mfploader"), t === f.currItem && (f._onImageHasSize(t), f.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, d("ImageLoadComplete")) : ++s < 200 ? setTimeout(o, 100) : n())
                    },
                    n = function () {
                    ...
                    r = f.st.image,
                    a = e.find(".mfp-img");
                return a.length && ((i = document.createElement("img")).className = "mfp-img", t.el && t.el.find("img").length && (i.alt = t.el.find("img").attr("alt")), t.img = c(i).on("load.mfploader", o).on("error.mfploader", n), i.src = t.src, a.is("img") && (t.img = t.img.clone()), 0 < (i = t.img[0]).naturalWidth ? t.hasSize = !0 : i.width || (t.hasSize = !1)), f._parseMarkup(e, {
                    title: function (t) {
                ...
                }, t), f.resizeImage(), t.hasSize ? (P && clearInterval(P), t.loadError ? (e.addClass("mfp-loading"), f.updateStatus("error", r.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), f.updateStatus("ready"))) : (f.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), f.findImageSize(t))), e
            }
        }
    });
    var O;
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function () {
                var t, e, i, s, o, n, r = f.st.zoom,
                    a = ".zoom";
                r.enabled && f.supportsTransition && (s = r.duration, o = function (t) {
            ...
            _getOffset: function (t) {
                ...
                return void 0 === O && (O = void 0 !== document.createElement("p").style.MozTransform), O ? s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)" : (s.left = i.left, s.top = i.top), s
            }
        }
    });
    ...
    c.magnificPopup.registerModule(j, {
        ...
        proto: {
            initIframe: function () {
                f.types.push(j), h("BeforeChange", function (t, e, i) {
                    e !== i && (e === j ? L() : i === j && L(!0))
                }), h(l + "." + j, function () {
                    L()
                })
    ...
    c.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function () {
                var n = f.st.gallery,
                    t = ".mfp-gallery";
                return f.direction = !0, !(!n || !n.enabled) && (g += " mfp-gallery", h(b + t, function () {
                ...
                }), h(v + t, function (t, e, i, s) {
                    var o = f.items.length;
                    i.counter = 1 < o ? F(n.tCounter, s.index, o) : ""
            ...
            _preloadItem: function (t) {
                var e;
                t = M(t), f.items[t].preloaded || ((e = f.items[t]).parsed || (e = f.parseEl(t)), d("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function () {
                    e.hasSize = !0
    ...
    c.magnificPopup.registerModule(q, {
        ...
        proto: {
            initRetina: function () {
                var i, s;
                1 < window.devicePixelRatio && (i = f.st.retina, s = i.ratio, 1 < (s = isNaN(s) ? s() : s) && (h("ImageHasSize." + q, function (t, e) {
                    e.img.css({
...
function (t, e) {
    ...
    ! function () {
        ...
        e.prototype.init = function () {
            ...
            f("body").append(s), this.$outer = f(".lg-outer"), this.$outer.focus(), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), o.setTop(), f(window).on("resize.lg orientationchange.lg", function () {
                setTimeout(function () {
                    o.setTop()
                }, 100)
            ...
            var e, i, s, o = null;
            this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? e = this.s.dynamicEl[t].subHtmlUrl : o = this.s.dynamicEl[t].subHtml : (i = this.$items.eq(t)).attr("data-sub-html-url") ? e = i.attr("data-sub-html-url") : (o = i.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !o && (o = i.attr("title") || i.find("img").first().attr("alt"))), e || (null != o ? "." !== (s = o.substring(0, 1)) && "#" !== s || (o = (this.s.subHtmlSelectorRelative && !this.s.dynamic ? i.find(o) : f(o)).html()) : o = ""), ".lg-sub-html" === this.s.appendSubHtmlTo ? e ? this.$outer.find(this.s.appendSubHtmlTo).load(e) : this.$outer.find(this.s.appendSubHtmlTo).html(o) : e ? this.$slide.eq(t).load(e) : this.$slide.eq(t).append(o), null != o && ("" === o ? this.$outer.find(this.s.appendSubHtmlTo).addClass("lg-empty-html") : this.$outer.find(this.s.appendSubHtmlTo).removeClass("lg-empty-html")), this.$el.trigger("onAfterAppendSubHtml.lg", [t])
            ...
            e.s.enableDrag && e.doCss() && (e.$slide.on("mousedown.lg", function (t) {
                e.$outer.hasClass("lg-zoomed") || e.lgBusy || f(t.target).text().trim() || (t.preventDefault(), e.manageSwipeClass(), i = t.pageX, o = !0, e.$outer.scrollLeft += 1, --e.$outer.scrollLeft, e.$outer.removeClass("lg-grab").addClass("lg-grabbing"), e.$el.trigger("onDragstart.lg"))
                ...
                n ? (n = !1, e.touchEnd(s - i), e.$el.trigger("onDragend.lg")) : (f(t.target).hasClass("lg-object") || f(t.target).hasClass("lg-video-play")) && e.$el.trigger("onSlideClick.lg"), o && (o = !1, e.$outer.removeClass("lg-grabbing").addClass("lg-grab"))
            }))
    ...
    ! function () {
        ...
        t.prototype.init = function () {
            ...
            n.core.s.actualSize && (t += '<button type="button" aria-label="Actual size" id="lg-actual-size" class="lg-icon"></button>'), n.core.s.useLeftForZoom ? n.core.$outer.addClass("lg-use-left-for-zoom") : n.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(t), n.core.$el.on("onSlideItemLoad.lg.tm.zoom", function (t, e, i) {
                ...
                d("body").hasClass("lg-from-hash") && i ? s = 0 : d("body").removeClass("lg-from-hash"), n.zoomabletimeout = setTimeout(function () {
            ...
            function s(t, e, i, s) {
                ...
                n.core.$outer.hasClass("lg-zoomed") ? a = 1 : o < e && (a = e / o || 2), s ? (n.pageX = d(window).width() / 2, n.pageY = d(window).height() / 2 + d(window).scrollTop()) : (n.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX, n.pageY = t.pageY || t.originalEvent.targetTouches[0].pageY), r(), setTimeout(function () {
            ...
            o.core.$slide.on("touchstart.lg", function (t) {
                var e;
                o.core.$outer.hasClass("lg-zoomed") && (e = o.core.$slide.eq(o.core.index).find(".lg-object"), s = o.core.$slide.eq(o.core.index).find(".lg-img-rotate")[0], h = o.getCurrentRotation(s), e = o.getDragAllowedAxises(e, Math.abs(h)), c = e.allowY, ((l = e.allowX) || c) && (t.preventDefault(), n = o.getSwipeCords(t, Math.abs(h))))
            }), o.core.$slide.on("touchmove.lg", function (t) {
                var e, i;
                o.core.$outer.hasClass("lg-zoomed") && (e = o.core.$slide.eq(o.core.index).find(".lg-img-wrap"), t.preventDefault(), a = !0, r = o.getSwipeCords(t, Math.abs(h)), o.core.$outer.addClass("lg-zoom-dragging"), i = c ? -Math.abs(e.attr("data-y")) + (r.y - n.y) * o.getModifier(h, "Y", s) : -Math.abs(e.attr("data-y")), t = l ? -Math.abs(e.attr("data-x")) + (r.x - n.x) * o.getModifier(h, "X", s) : -Math.abs(e.attr("data-x")), (15 < Math.abs(r.x - n.x) || 15 < Math.abs(r.y - n.y)) && (o.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)")))
            }), o.core.$slide.on("touchend.lg", function () {
                o.core.$outer.hasClass("lg-zoomed") && a && (a = !1, o.core.$outer.removeClass("lg-zoom-dragging"), o.touchendZoom(n, r, l, c, h))
            })
            ...
            o.core.$slide.on("mousedown.lg.zoom", function (t) {
                s = o.core.$slide.eq(o.core.index).find(".lg-img-rotate")[0], u = o.getCurrentRotation(s);
                var e = o.core.$slide.eq(o.core.index).find(".lg-object"),
                    e = o.getDragAllowedAxises(e, Math.abs(u));
                h = e.allowY, c = e.allowX, o.core.$outer.hasClass("lg-zoomed") && d(t.target).hasClass("lg-object") && (c || h) && (t.preventDefault(), n = o.getDragCords(t, Math.abs(u)), a = !0, o.core.$outer.scrollLeft += 1, --o.core.$outer.scrollLeft, o.core.$outer.removeClass("lg-grab").addClass("lg-grabbing"))
            }), d(window).on("mousemove.lg.zoom", function (t) {
                var e, i;
                a && (e = o.core.$slide.eq(o.core.index).find(".lg-img-wrap"), l = !0, r = o.getDragCords(t, Math.abs(u)), o.core.$outer.addClass("lg-zoom-dragging"), i = h ? -Math.abs(e.attr("data-y")) + (r.y - n.y) * o.getModifier(u, "Y", s) : -Math.abs(e.attr("data-y")), t = c ? -Math.abs(e.attr("data-x")) + (r.x - n.x) * o.getModifier(u, "X", s) : -Math.abs(e.attr("data-x")), o.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)"))
            }), d(window).on("mouseup.lg.zoom", function (t) {
                a && (a = !1, o.core.$outer.removeClass("lg-zoom-dragging"), !l || n.x === r.x && n.y === r.y || (r = o.getDragCords(t, Math.abs(u)), o.touchendZoom(n, r, c, h, u)), l = !1), o.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")
            })
...
function (t) {
    ...
    function e(t) {
        var e, i = t || window.event,
            ...
            l = 0,
            c = 0;
        if ((t = h.event.fix(i)).type = "mousewheel", "detail" in i && (r = -1 * i.detail), "wheelDelta" in i && (r = i.wheelDelta), "wheelDeltaY" in i && (r = i.wheelDeltaY), "wheelDeltaX" in i && (n = -1 * i.wheelDeltaX), "axis" in i && i.axis === i.HORIZONTAL_AXIS && (n = -1 * r, r = 0), o = 0 === r ? n : r, "deltaY" in i && (o = r = -1 * i.deltaY), "deltaX" in i && (n = i.deltaX, 0 === r && (o = -1 * n)), 0 !== r || 0 !== n) {
            1 === i.deltaMode ? (o *= e = h.data(this, "mousewheel-line-height"), r *= e, n *= e) : 2 === i.deltaMode && (o *= e = h.data(this, "mousewheel-page-height"), r *= e, n *= e);
            var a = Math.max(Math.abs(r), Math.abs(n));
            return f && !(a < f) || d(i, f = a) && (f /= 40), d(i, a) && (o /= 40, n /= 40, r /= 40), o = Math[1 <= o ? "floor" : "ceil"](o / f), n = Math[1 <= n ? "floor" : "ceil"](n / f), r = Math[1 <= r ? "floor" : "ceil"](r / f), g.settings.normalizeOffset && this.getBoundingClientRect && (a = this.getBoundingClientRect(), l = t.clientX - a.left, c = t.clientY - a.top), t.deltaX = n, t.deltaY = r, t.deltaFactor = f, t.offsetX = l, t.offsetY = c, t.deltaMode = 0, s.unshift(t, o, n, r), p && clearTimeout(p), p = setTimeout(u, 200), (h.event.dispatch || h.event.handle).apply(this, s)
        }
    }
...
function (t, e) {
    ...
    function m(t) {
        if (b || (b = !0, (d = document.createElement("div")).style.width = "200px", d.style.padding = "1px 2px 3px 4px", d.style.borderStyle = "solid", d.style.borderWidth = "1px 2px 3px 4px", d.style.boxSizing = "border-box", (u = document.body || document.documentElement).appendChild(d), h = f(d), m.isBoxSizeOuter = g = 200 == p(h.width), u.removeChild(d)), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
            var e = f(t);
            ...
            s = p(e.height);
            return !1 !== s && (i.height = s + (t ? 0 : l + d)), i.innerWidth = i.width - (a + u), i.innerHeight = i.height - (l + d), i.outerWidth = i.width + c, i.outerHeight = i.height + h, i
        }
        var d, u, h
    }
...
function (t, e) {
    ...
    t.constructor = i, t._create = function () {
        ...
        var t = getComputedStyle(this.element),
            ...
            o = t[i ? "top" : "bottom"],
            t = this.layout.size,
            s = -1 != s.indexOf("%") ? parseFloat(s) / 100 * t.width : parseInt(s, 10),
            o = -1 != o.indexOf("%") ? parseFloat(o) / 100 * t.height : parseInt(o, 10),
            s = isNaN(s) ? 0 : s,
            o = isNaN(o) ? 0 : o;
        s -= e ? t.paddingLeft : t.paddingRight, o -= i ? t.paddingTop : t.paddingBottom, this.position.x = s, this.position.y = o
        ...
        e[n] = this.getXValue(o), e[i] = "";
        o = s ? "paddingTop" : "paddingBottom", i = s ? "top" : "bottom", s = s ? "bottom" : "top", o = this.position.y + t[o];
        e[i] = this.getYValue(o), e[s] = "", this.css(e), this.emitEvent("layout", [this])
        ...
        var i = this.position.x,
            ...
            o = parseInt(t, 10),
            n = parseInt(e, 10),
            n = o === this.position.x && n === this.position.y;
...
function (o, n) {
    ...
    function r(t, e) {
        ...
        i ? (this.element = i, c && (this.$element = c(this.element)), this.options = s.extend({}, this.constructor.defaults), this.option(e), e = ++h, this.element.outlayerGUID = e, (u[e] = this)._create(), this._getOption("initLayout") && this.layout()) : l && l.error("Bad element for " + this.constructor.namespace + ": " + (i || t))
    }
...
function (t, e) {
    ...
    return t._resetLayout = function () {
        ...
        for (var n = (this._getOption("originTop") ? i.top : i.bottom) + e.outerHeight, r = s; r <= o; r++) this.colYs[r] = Math.max(n, this.colYs[r])
...
function (r, a) {
    ...
    o._create = function () {
        ...
        for (var e = (e = this.options.filter) || "*", i = [], s = [], o = [], n = this._getFilterTest(e), r = 0; r < t.length; r++) {
            var a, l = t[r];
    ...
    return o.remove = function (t) {
        ...
        function p(t) {
            ...
            t.parents(".cd-headline").hasClass("type") ? ((e = t.parent(".cd-words-wrapper")).addClass("selected").removeClass("waiting"), setTimeout(function () {
                ...
                f(s, c)
            }, u)) : t.parents(".cd-headline").hasClass("letters") ? (i = t.children("i").length >= s.children("i").length, function t(e, i, s, o) {
                ...
                e.is(":last-child") ? s && setTimeout(function () {
                    ...
                    var n;
                    e.is(":last-child") && r("html").hasClass("no-csstransitions") && (n = g(i), y(i, n))
                }
            }(t.find("i").eq(0), t, i, o), m(s.find("i").eq(0), s, i, o)) : t.parents(".cd-headline").hasClass("clip") ? t.parents(".cd-words-wrapper").animate({
                width: "2px"
            }, d, function () {
                y(t, s), f(s)
        ...
        r(".cd-headline.letters").find("b").each(function () {
            ...
            function (t) {
                ...
                t.each(function () {
                    var t, e, i, s = r(this);
                    s.hasClass("loading-bar") ? (o = n, setTimeout(function () {
                        s.find(".cd-words-wrapper").addClass("is-loading")
                    }, l)) : s.hasClass("clip") ? (e = (t = s.find(".cd-words-wrapper")).width() + 10, t.css("width", e)) : s.hasClass("type") || (e = s.find(".cd-words-wrapper b"), i = 0, e.each(function () {
                        var t = r(this).width();
                        i < t && (i = t)
                    }), s.find(".cd-words-wrapper").css("width", i)), setTimeout(function () {
                        p(s.find(".is-visible").eq(0))
                    }, o)
                })
            }(r(".cd-headline"))
    }),
    function () {
        ...
        h.prototype.extend = function (t, e) {
        ...
        }, c), s = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (a.notSupported = !0, a.prototype.observe = function () {}, a), l = this.getComputedStyle || function (i, t) {
            ...
            if (this.stopped = !1, this.boxes = function () {
                    for (var t, e = [], i = 0, s = (t = this.element.querySelectorAll("." + this.config.boxClass)).length; i < s; i++) o = t[i], e.push(o);
                    return e
                }.call(this), this.all = function () {
                    for (var t, e = [], i = 0, s = (t = this.boxes).length; i < s; i++) o = t[i], e.push(o);
                    return e
                }.call(this), this.boxes.length)
                if (this.disabled()) this.resetStyle();
                else
                    for (t = 0, e = (i = this.boxes).length; t < e; t++) o = i[t], this.applyStyle(o, !0);
            return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new s((r = this, function (t) {
                for (var o, n, e = [], i = 0, s = t.length; i < s; i++) n = t[i], e.push(function () {
                    for (var t, e = [], i = 0, s = (t = n.addedNodes || []).length; i < s; i++) o = t[i], e.push(this.doSync(o));
                    return e
                }.call(r));
                return e
            ...
            for (var t, e, i = [], s = 0, o = (e = this.boxes).length; s < o; s++) t = e[s], i.push(t.style.visibility = "visible");
            return i
            ...
            var n, r, a, e = [];
            for (n in t) r = t[n], o["" + n] = r, e.push(function () {
                for (var t, e = [], i = 0, s = (t = this.vendors).length; i < s; i++) a = t[i], e.push(o["" + a + n.charAt(0).toUpperCase() + n.substr(1)] = r);
                return e
            }.call(this));
            return e
        }, n.prototype.vendorCSS = function (t, e) {
            for (var i, s, o, n = (s = l(t)).getPropertyCSSValue(e), r = 0, a = (i = this.vendors).length; r < a; r++) o = i[r], n = n || s.getPropertyCSSValue("-" + o + "-" + e);
            return n
            ...
            return !this.scrolled || (this.scrolled = !1, this.boxes = function () {
                for (var t, e = [], i = 0, s = (t = this.boxes).length; i < s; i++)(o = t[i]) && (this.isVisible(o) ? this.show(o) : e.push(o));
                return e
    ...
    function (n) {
        function e(t, e, i, s) {
            var e = t.text().split(e),
                o = "";
            e.length && (n(e).each(function (t, e) {
                o += '<span class="' + i + (t + 1) + '">' + e + "</span>" + s
            }), t.empty().append(o))
        }
        var i = {
            init: function () {
            ...
            lines: function () {
                return this.each(function () {
                    ...
                    e(n(this).children("br").replaceWith(t).end(), t, "line", "")
                })
            }
        };
        n.fn.lettering = function (t) {
            return t && i[t] ? i[t].apply(this, [].slice.call(arguments, 1)) : "letters" !== t && t ? (n.error("Method " + t + " does not exist on jQuery.lettering"), this) : i.init.apply(this, [].slice.call(arguments, 0))
        }
    }(jQuery),
    function (a) {
        "use strict";
        ...
        function r(t) {
            ...
            return t.length && a.each(t, function (t, e) {
                ...
                /^data-in-*/.test(i) ? (s.in = s.in || {}, s.in[i.replace(/data-in-/, "")] = o(e.nodeValue)) : /^data-out-*/.test(i) ? (s.out = s.out || {}, s.out[i.replace(/data-out-/, "")] = o(e.nodeValue)) : /^data-*/.test(i) && (s[i.replace(/data-/, "")] = o(e.nodeValue))
            }), s
        }

        function h(t, n, i) {
            var r = t.length;
            r ? (n.shuffle && (t = function (t) {
                for (var e, i, s = t.length; s; e = parseInt(Math.random() * s), i = t[--s], t[s] = t[e], t[e] = i);
                return t
            }(t)), n.reverse && (t = t.toArray().reverse()), a.each(t, function (t, e) {
                var s = a(e);

                function o() {
                    l(n.effect) ? s.css("visibility", "visible") : c(n.effect) && s.css("visibility", "hidden"), !--r && i && i()
                }
                t = n.sync ? n.delay : n.delay * t * n.delayScale;
                s.text() ? setTimeout(function () {
                    var t, e, i;
                    t = s, e = n.effect, i = o, t.addClass("animated " + e).css("visibility", "visible").show(), t.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
        ...
        function n(t, e) {
            var o = this,
                n = a(t);
            o.init = function () {
                o.$texts = n.find(e.selector), o.$texts.length || (o.$texts = a('<ul class="texts"><li>' + n.html() + "</li></ul>"), n.html(o.$texts)), o.$texts.hide(), o.$current = a("<span>").html(o.$texts.find(":first-child").html()).prependTo(n), l(e.in.effect) ? o.$current.css("visibility", "hidden") : c(e.out.effect) && o.$current.css("visibility", "visible"), o.setOptions(e), o.timeoutRun = null, setTimeout(function () {
                ...
                t = a.Event(t + ".tlt");
                return n.trigger(t, o), t
            }, o.in = function (t, e) {
                t = t || 0;
                var i = o.$texts.find(":nth-child(" + ((t || 0) + 1) + ")"),
                    s = a.extend(!0, {}, o.options, i.length ? r(i[0]) : {});
                i.addClass("current"), o.triggerEvent("inAnimationBegin"), n.attr("data-active", i.data("id")), o.$current.html(i.html()).lettering("words"), "char" == o.options.type && o.$current.find('[class^="word"]').css({
                    ...
                    a(this).lettering()
                }), i = o.$current.find('[class^="' + o.options.type + '"]').css("display", "inline-block"), l(s.in.effect) ? i.css("visibility", "hidden") : c(s.in.effect) && i.css("visibility", "visible"), o.currentIndex = t, h(i, s.in, function () {
                    o.triggerEvent("inAnimationEnd"), s.in.callback && s.in.callback(), e && e(o)
                })
            }, o.out = function (t) {
                var e = o.$texts.find(":nth-child(" + ((o.currentIndex || 0) + 1) + ")"),
                    i = o.$current.find('[class^="' + o.options.type + '"]'),
                    s = a.extend(!0, {}, o.options, e.length ? r(e[0]) : {});
                o.triggerEvent("outAnimationBegin"), h(i, s.out, function () {
                    e.removeClass("current"), o.triggerEvent("outAnimationEnd"), n.removeAttr("data-active"), s.out.callback && s.out.callback(), t && t(o)
                })
            }, o.start = function (t) {
                setTimeout(function () {
                    o.triggerEvent("start"),
                        function e(i) {
                            o.in(i, function () {
                                var t = o.$texts.children().length;
                                i += 1, !o.options.loop && t <= i ? (o.options.callback && o.options.callback(), o.triggerEvent("end")) : (i %= t, o.timeoutRun = setTimeout(function () {
                                    o.out(function () {
                                        e(i)
                                    })
        ...
        a.fn.textillate = function (s, o) {
            return this.each(function () {
                var t = a(this),
                    e = t.data("textillate"),
                    i = a.extend(!0, {}, a.fn.textillate.defaults, r(this), "object" == typeof s && s);
                e ? "string" == typeof s ? e[s].apply(e, [].concat(o)) : e.setOptions.call(e, i) : t.data("textillate", e = new n(this, i))
            })
    ...
    return h.fn.tilt = function (e) {
        ...
        function n() {
            var t = h(this).outerWidth(),
                ...
                n = (this.mousePositions.y - s) / e;
            return {
                tiltX: (this.settings.maxTilt / 2 - o * this.settings.maxTilt).toFixed(2),
                tiltY: (n * this.settings.maxTilt - this.settings.maxTilt / 2).toFixed(2),
                percentageX: 100 * o,
                percentageY: 100 * n,
        ...
        return h.fn.tilt.destroy = function () {
            ...
            return h(this).each(function () {
                this.mousePositions = o.call(this), t.push(n.call(this))
            }), t
        }, h.fn.tilt.reset = function () {
            h(this).each(function () {
                var t = this;
                this.mousePositions = o.call(this), this.settings = h(this).data("settings"), l.call(this), setTimeout(function () {
                    t.reset = !1
    ...
    return s = {}, o.m = i = [function (t, e, i) {
        ...
        o(a, [{
            ...
            value: function () {
                ...
                this.fakeElem.style.top = e + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value = this.text, this.container.appendChild(this.fakeElem), this.selectedText = (0, n.default)(this.fakeElem), this.copyText()
            }
        }, {
            key: "removeFake",
            value: function () {
        ...
        t.exports = function (t, e, i) {
            ...
            if (c.nodeList(t)) return s = t, o = e, n = i, Array.prototype.forEach.call(s, function (t) {
        ...
        function n(t, e, i, s, o) {
            ...
            return t.addEventListener(i, n, o), {
                destroy: function () {
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function (l) {
            ...
            E = {
                ...
                util: {
                    ...
                    clone: function i(t, s) {
                        var o, e, n = E.util.type(t);
                        switch (s = s || {}, n) {
                            case "Object":
                                if (e = E.util.objId(t), s[e]) return s[e];
                                for (var r in o = {}, s[e] = o, t) t.hasOwnProperty(r) && (o[r] = i(t[r], s));
                                return o;
                            case "Array":
                                return e = E.util.objId(t), s[e] || (o = [], s[e] = o, t.forEach(function (t, e) {
                                    o[e] = i(t, s)
                                }), o);
                            default:
                                return t
                ...
                languages: {
                    extend: function (t, e) {
                        var i, s = E.util.clone(E.languages[t]);
                        for (i in e) s[i] = e[i];
                        return s
                    },
                    insertBefore: function (i, t, e, s) {
                        var o, n = (s = s || E.languages)[i],
                            r = {};
                        for (o in n)
                        ...
                        return s[i] = r, E.languages.DFS(E.languages, function (t, e) {
                            e === l && t != i && (this[t] = r)
                        }), r
                    },
                    DFS: function t(e, i, s, o) {
                        o = o || {};
                        var n, r, a, l = E.util.objId;
                        for (n in e) e.hasOwnProperty(n) && (i.call(e, n, e[n], s || n), r = e[n], "Object" !== (a = E.util.type(r)) || o[l(r)] ? "Array" !== a || o[l(r)] || (o[l(r)] = !0, t(r, i, n, o)) : (o[l(r)] = !0, t(r, i, null, o)))
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function (t, e, i) {
                    ...
                    for (var o, n = s.elements || t.querySelectorAll(s.selector), r = 0; o = n[r++];) E.highlightElement(o, !0 === e, s.callback)
                },
                highlightElement: function (t, e, i) {
                    for (var s, o = "none", n = t; n && !c.test(n.className);) n = n.parentNode;
                    n && (o = (n.className.match(c) || [, "none"])[1].toLowerCase(), s = E.languages[o]), t.className = t.className.replace(c, "").replace(/\s+/g, " ") + " language-" + o, t.parentNode && (n = t.parentNode, /pre/i.test(n.nodeName) && (n.className = n.className.replace(c, "").replace(/\s+/g, " ") + " language-" + o));
                    ...
                    for (var a in i)
                        if (i.hasOwnProperty(a) && i[a]) {
                            ...
                            for (var l = i[a], l = "Array" === E.util.type(l) ? l : [l], c = 0; c < l.length; ++c) {
                                ...
                                for (var y = s, v = o; y < e.length; v += e[y].length, ++y) {
                                    var b = e[y];
                                    ...
                                    if (!(b instanceof I)) {
                                        ...
                                        if (T) {
                                            p && (m = T[1] ? T[1].length : 0), _ = (w = T.index + m) + (T = T[0].slice(m)).length;
                                            var k = b.slice(0, w),
                                                z = b.slice(_),
                                                b = [y, S];
                                            k && (++y, v += k.length, b.push(k));
                                            k = new I(a, d ? E.tokenize(T, d) : T, g, T, f);
                                            if (b.push(k), z && b.push(z), Array.prototype.splice.apply(e, b), 1 != S && E.matchGrammar(t, e, i, y, v, !0, a), n) break
                                        } else if (n) break
                                    }
                                }
                            }
        ...
        function I(t, e, i, s, o) {
            this.type = t, this.content = e, this.alias = i, this.length = 0 | (s || "").length, this.greedy = !!o
        }
        if (l.Prism = E, I.stringify = function (t, e) {
                ...
                t.alias && (s = Array.isArray(t.alias) ? t.alias : [t.alias], Array.prototype.push.apply(i.classes, s)), E.hooks.run("wrap", i);
